...
;
        ...
        void YeniKaydet()
        {
            ...
            for (int i = 0; i < liste.RowCount; i++)
            {
                ...
                decimal YTopFiyat = 0;
                decimal obFiyat; //ob den sonra yaptık.
                decimal ETopObFiyat;
                ...
                YTopFiyat = Convert.ToDecimal(liste.Rows[i].Cells[3].Value) * Convert.ToInt32(liste.Rows[i].Cells[4].Value);

                decimal TopEYFiyat = ETopObFiyat + YTopFiyat;
